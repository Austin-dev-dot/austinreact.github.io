      ...
      <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
        ...
        />
         ...
         >
          ...
          >
            Demonstrating proficiency in both front-end frameworks and core programming languages, 
            forming a balanced foundation for scalable application development.
          </motion.p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            animate={isInView ? "visible" : "hidden"}
            variants={containerVariants}
            className="grid md:grid-cols-2 gap-8 lg:gap-12 relative z-10"
          >
         ...
         >
           <motion.div variants={itemsVariants} className="text-center mb-8">
             <h3 className="text-xl font-medium mb-4">Some to be worked with and currently working</h3>
           </motion.div>
